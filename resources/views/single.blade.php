        ...
        @foreach ($posts as $post)
            <div style="border: 5px solid black;">
                ...
                <p>{{ $post->text }}</p>
                        ...
                        <a href="{{ route('editpost',["id"=>$post->id ]) }}" class="btn btn-warning">
                            განახლება
                        </a>
                        <a href="{{ route('showpost',["id"=>$post->id ]) }}" class="btn btn-success">
                            დათვალიერება
                        </a>
...
<div style="border: 5px solid black;">
    ...
    <p style="max-width: 200px;">Email: {{ $comment["email"] }}</p>
    <p>{{ $comment["comment"] }}</p>
